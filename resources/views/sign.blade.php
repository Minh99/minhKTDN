...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
       ...
       <div style="background-image: url('https://i1.wp.com/thuvienanh.net/wp-content/uploads/2019/03/hinh-nen-powerpoint-mau-xanh-6.jpeg?resize=2560%2C1440&ssl=1');background-repeat: no-repeat; height: 650px;margin: 0">
        <div style="height: 50px"></div>
        <div style="width: 30%;margin:auto;padding: 50px; border: 5px solid #17a2b8!important ; border-radius: 20px">
                  ...
                  <form class="form-signin" action="{{URL::to('/log')}}" method="POST">
                  {{ csrf_field() }} 
